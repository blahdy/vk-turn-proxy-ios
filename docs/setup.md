...
XXX.XXX.XXX.XXX - публичный адрес сервера, на котором запущен WDTT. Порт - по умолчанию WDTT использует 56000. Пароль - то, что у WDTT называется "главный пароль туннеля". 
...
Пример запуска при добавлении нового клиента: python3 quick_link.py -gen-peer-key 192.168.100.2/24
